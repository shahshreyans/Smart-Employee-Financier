            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform"  method="get" modelAttribute="employeeList" action="insertEmployee">
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <f:input  class="form-control" path="loginVO.username" type="email"/>
                      </div>
                      <div class="form-group">
                      ...
                      <f:select path="departmentVO.departmentId">
                       ...
                       <div class="form-group">
                        ...
                        <f:input  class="form-control" path="employeeId" type="text"/>
                      </div> -->
                      <div class="form-group">

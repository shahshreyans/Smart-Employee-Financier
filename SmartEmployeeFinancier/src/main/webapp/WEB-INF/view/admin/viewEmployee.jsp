                ...
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                       <c:forEach items="${serchempList }" var="i">
                        <tr>
                            <td>${i.employeeId}</td>
                            <td>${i.employeeName}</td>
                            <td>${i.gender}</td>
                            <td>${i.departmentVO.departmentId}</td>
                            <td>${i.loginVO.username}</td>
                           <td>${i.phoneNo}</td>
                            <td>${i.address}</td>
                            <td><a href="deleteEmployee?employeeId=${i.employeeId}">DELETE</a>/		
                           		<a href="editEmployee?employeeId=${i.employeeId}">EDIT</a></td>

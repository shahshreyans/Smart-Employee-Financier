            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform" method="get" modelAttribute="deptList" action="insertDepartment">
                    <fieldset>
                      <div class="form-group">
                        <label for="departname">Department Name</label>
                        <f:input class="form-control" path="departmentName" type="text"/>
                        
                      </div>
                      <div class="form-group">
                        <label for="description">Description</label>
                        <f:textarea id="description" rows="5" cols="5" path="departmentDescription" class="form-control"></f:textarea>
                      </div>

            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform"  method="get" action="insertHR" modelAttribute="hrList">
                    <fieldset>
                      <div class="form-group">
                        <label for="hrname">HR Name</label>
                        <f:input id="hrname" class="form-control" path="hrName" type="text"/>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <f:input id="email" class="form-control" path="loginVO.username" type="email"/>
                      </div>
                      <div class="form-group">
                        <label for="department">Department</label>
                               
                      <f:select path="departmentVO.departmentId">
                       
                         <f:options items="${departmentList}"  itemLabel="departmentName"  itemValue="departmentId"/>
                      </f:select>
                        </div>
                     <!--  <div class="form-group">
                        <label for="hrid">HR Id</label>
                        <input id="hrid" class="form-control" name="hrid" type="text">
                      </div> -->
                      <div class="form-group">

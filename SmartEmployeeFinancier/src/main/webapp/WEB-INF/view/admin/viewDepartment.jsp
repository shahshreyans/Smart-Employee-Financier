                ...
                <div class="col-12">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                      <c:forEach items="${serchdeptList }" var="i">
                        <tr>
                            <td>${i.departmentId}</td>
                            <td>${i.departmentName}</td>
                            <td>${i.departmentDescription}</td>
                           		<td><a href="deleteDepartment?departmentId=${i.departmentId}">DELETE</a>/		
                           		<a href="editDepartment?departmentId=${i.departmentId}">EDIT</a></td>

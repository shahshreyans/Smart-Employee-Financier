            ...
            <div class="col-lg-12">
              <div class="card">
                ...
                <%@taglib prefix="f" uri="http://www.springframework.org/tags/form" %>
                  ...
                  <f:form class="cmxform"  method="post" action="insertRaiting" modelAttribute="feedbackVO" >
                
                    <fieldset>
                
                      <div class="form-group">
                        <label for="feedback">Feedback</label>
                        <f:textarea  rows="5" cols="5" path="feedBack" class="form-control"/>
                      </div>
                      
                     
                 <div class="form-group">
    					<h4> <label for="feedback">Rating</label></h4>
    				<div class="rating">
